...
export default async function VendorPaymentsPage({ searchParams }: PageProps) {
  ...
  const [
    ...
    listPartnerPayments(user, "VENDOR", {
            ...
            fields={[
              {
                ...
                label: "Search",
                type: "search",
                placeholder: "Voucher No, vendor, reference…",
              },
              {
                key: "direction",
                label: "Payment Type",
                ...
                options: [
                  ...
                  { value: "CREDIT", label: "Receipt / Refund (Money In)" },
                ],
              },
              {
                key: "paymentMethod",
            ...
            <table className="w-full min-w-[960px] text-sm">
              <thead>
                <tr className="border-b bg-muted/50 text-xs uppercase tracking-wide text-muted-foreground font-semibold">
                  ...
                  <th scope="col" className="px-4 py-3 text-left font-bold">Vendor Name</th>
