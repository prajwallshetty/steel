 ...
 * workbook.
 *
 * It is the fixture the engine tests reconcile against, and the row the
 * database seed inserts, so the printed sheet can be compared with the
 * original the moment the app starts.
 */
